...
const testActions = (): Record<string, () => Promise<any>> => {
	return {
		...
		imageMakeEnv: image.testBootstrapMakeEnv,
		imageMakeEnvImageDocker: image.testBootstrapMakeEnvImageDocker,
		imageMakeEnvImageOci: image.testBootstrapMakeEnvImageOci,
